...
**name** — its label when the layout gives it one, else its key ([§ 4.6](#46-the-building-layout),
card#9273), wherever the screen says which floor it is showing, and never the key drawn beside the
label — one
...
the same clause as a duplicated label. ⚠ **What the reader cannot check, named:** a label equal to
