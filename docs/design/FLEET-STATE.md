...
GET /api/fleet/stream                       -- session + MFA middleware (§ 9); text/event-stream
  ...
  --        (card#9467), and a hold row stamped after server_now counts feed_prefix_future (§ 7.2)
